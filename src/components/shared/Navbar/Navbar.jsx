  ...
  return (
    <div className="navbar bg-base-100 shadow-md font-display max-w-7xl mx-auto">
      ...
      <div className="navbar-end">
        ...
        {user && <button onClick={handleLogout} className="btn bg-[#82B440] text-white normal-case">Logout</button>}
        <label className="swap swap-rotate m-5">
          <input onChange={themeToggle} type="checkbox" checked={theme === 'light' ? false : true} />
